...
class TestLoginPage:
    ...
    def _get_credentials_from_page(self, login_page: LoginPage) -> Tuple:
    ...
    def test_valid_user_should_be_able_to_log_in(self, driver, login_page: LoginPage):
        login_page.navigate()
        (accepted_usernames, password) = self._get_credentials_from_page(login_page)
    ...
    def test_invalid_users_should_not_be_able_to_log_in(self, driver, login_page: LoginPage, username: str,
                                                        password: str,
    ...
    def test_erratic_users_should_be_able_to_log_in(self, driver, login_page: LoginPage, username: str):
        login_page.navigate()
