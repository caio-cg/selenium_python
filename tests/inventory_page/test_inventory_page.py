...
class TestInventoryPage:
    ...
    def set_user_session(self, driver):
    ...
    def test_inventory_page_should_list_all_products(self, inventory_page):
        inventory_page.navigate()
        product_names = inventory_page.get_all_product_names()

        assert len(product_names) > 0

    def test_inventory_page_should_list_all_products_fully(self, inventory_page):
        inventory_page.navigate()
